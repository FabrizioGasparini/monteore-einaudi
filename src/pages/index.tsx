    ...
    return (
        <div className='w-full min-h-screen h-full bg-[#181818]'>
            <header className='flex items-center justify-center flex-col p-2'>
                ...
                <h1 className='text-4xl md:text-6xl mt-10 text-center'>BENVENUTO {name}!</h1>
                <p>{classeUser}</p>
            </header>
            <main className="min-h-screen px-4 pt-8 flex-1 flex flex-col justify-center items-center text-center align-middle">
